...
<div id="main_container">
    ...
    <div class="logo"><a href="#"><img src="${crunchifyJS }" alt="" title="" border="0" /></a></div>
         ...
         <form action="/EnablementAppWeb/loginSuccess" method="post" class="niceform">
         
                <fieldset>
                    <dl>
                        <dt><label for="email">Username:</label></dt>
                        <dd><input type="text" name="userid" id="" size="54" /></dd>
                    </dl>
                    <dl>
                        <dt><label for="password">Password:</label></dt>
                        <dd><input type="text" name="pswd" id="" size="54" /></dd>
                    </dl>
                    ...
                    <input type="checkbox" name="interests[]" id="" value="" /><label class="check_label">Remember me</label>
                     ...
                     <dl class="submit">
                    <input type="submit" name="submit" id="submit" value="Enter"  onclick="loginvalidate()" />
                     </dl>

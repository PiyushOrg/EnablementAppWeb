		...
		<div class="main_content">
			...
			<div class="center_content">
				...
				<div class="right_content">
					<h2 align="center">SEND NOTIFICATIONS</h2>
					<div class="form">
						<form action="/EnablementAppWeb/eventadded" method="post"
							class="niceform" id="myform">
							<fieldset>
								<dl>
									<dt>
										<label for="Subject"> Email Subject </label></dt>
									...
									<dd>
										<textarea name="comments" id="messagebody" rows="20" cols="46"></textarea>
									</dd>
